...
public class Level6 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbtnB1.setText("Menanam Cangkul");
        ...
        jbtnB2.setText("Menanam Cangkul");
        ...
        jhint.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Tebak_Lagu/img/menanam-jagung.png"))); // NOI18N
    ...
    private void jbtnPlay2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbtnPlay2MouseClicked
        ...
        if (a==0){
            try {
                FileInputStream fis = new FileInputStream("src/Tebak_Lagu/lagu/menanam jagung.mp3");
    ...
    private void jbtnC2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbtnC2MouseClicked
        ...
        this.setVisible(false);
        new Level7(skor).setVisible(true);
