...
public class Level3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jhint.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Tebak_Lagu/img/bintang-kecil.png"))); // NOI18N
        jPanel1.add(jhint, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 496, 340, 81));
    ...
    private void jbtnPlay2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbtnPlay2MouseClicked
        ...
        if (a==0){
            try {
                FileInputStream fis = new FileInputStream("src/Tebak_Lagu/lagu/bintang-kecil.mp3");
