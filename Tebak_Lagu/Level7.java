...
public class Level7 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbtnB1.setText("Naik Kereta Api");
        ...
        jbtnB2.setText("Naik Kereta Api");
        ...
        jbtnC1.setText("Ke Bandung-Yogyakarta");
        ...
        jbtnC2.setText("Ke Bandung-Yogyakarta");
        ...
        jbtnD1.setText("Pada Hari Minggu");
        ...
        jbtnD2.setText("Pada Hari Minggu");
        ...
        jhint.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Tebak_Lagu/img/naik-kereta-api.png"))); // NOI18N
    ...
    private void jbtnPlay2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbtnPlay2MouseClicked
        ...
        if (a==0){
            try {
                FileInputStream fis = new FileInputStream("src/Tebak_Lagu/lagu/naik kereta api.mp3");
    ...
    private void jbtnB2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbtnB2MouseClicked
        ...
        this.setVisible(false);
        new Level8(skor).setVisible(true);
